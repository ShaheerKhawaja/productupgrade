...
This is the Codex-native workflow wrapper for [.claude/commands/productionos-update.md](../../.claude/commands/productionos-update.md).

Use it when the user wants this exact ProductionOS workflow, not just the umbrella `productionos` router.

## Source of Truth

1. Read the source command spec at [.claude/commands/productionos-update.md](../../.claude/commands/productionos-update.md).
...
- Summary: Update ProductionOS plugin to the latest version from GitHub
