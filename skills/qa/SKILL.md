...
This is the Codex-native workflow wrapper for [.claude/commands/qa.md](../../.claude/commands/qa.md).

Use it when the user wants this exact ProductionOS workflow, not just the umbrella `productionos` router.

## Source of Truth

1. Read the source command spec at [.claude/commands/qa.md](../../.claude/commands/qa.md).
